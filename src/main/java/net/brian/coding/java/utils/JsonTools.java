...
//                  new DateJsonValueProcessor(datePattern));   
     ...
     * @return
     */
    public static <T> String beanListToJson(List<T> beans, String[] _nory_changes, boolean nory) {
        ...
        String s_json = "{";
         ...
         for (Iterator<?> it = key.iterator(); it.hasNext();) {
             ...
             if(map.get(s) == null){
                 ...
                 s_json+=(s+":"+JsonTools.beanListToJson((List<?>)map.get(s), _nory_changes, nory));
